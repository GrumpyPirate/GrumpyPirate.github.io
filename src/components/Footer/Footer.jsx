      ...
      <div className="footer__credits">
        <div className="container-fluid">
          <div className="last-child-mb-0">
            <p className="mb-0">
              Made with <a href="https://facebook.github.io/react/" target="_blank" className="footer__icon link-inherit" title="React"><Icon glyph="react" altText="React"/></a>, <a href="https://webpack.js.org/" target="_blank" className="footer__icon link-inherit" title="Webpack"><Icon glyph="webpack" altText="Webpack 2"/></a>, <a href="https://www.contentful.com/" target="_blank" className="footer__icon link-inherit" title="Contentful"><Icon glyph="contentful" altText="Contentful"/></a> and <span className="footer__icon"><Icon glyph="heart" altText="love"/></span>
            </p>
